...
export default function CinematicOverlay() {
  ...
  return (
    <div ref={containerRef} className="relative w-full z-10 pointer-events-none">
      ...
      {/* ===== FIXED LEFT-SIDE TELEMETRY HUD PANEL ===== */}
      <div className="fixed left-6 top-28 z-40 hidden lg:flex flex-col gap-3 w-80 pointer-events-auto">
        {/* Card 1: Satellite Live Telemetry */}
        <div className="bg-black/60 border border-[#00B4D8]/40 backdrop-blur-xl rounded-2xl p-4 shadow-[0_0_25px_rgba(0,180,216,0.15)] transition-all hover:border-[#00B4D8]">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <Satellite className="w-4 h-4 text-[#00B4D8] animate-pulse" />
              <span className="text-[11px] font-mono font-bold tracking-wider text-[#00B4D8]">SENTINEL-1A SAR OVERWATCH</span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-[10px] font-mono text-gray-300 mt-2 bg-black/40 p-2.5 rounded-xl border border-white/5">
            <div>
              <p className="text-gray-400">ALTITUDE</p>
              <p className="font-bold text-white">693.4 km</p>
            </div>
            <div>
              <p className="text-gray-400">INC: 98.18°</p>
              <p className="font-bold text-white">SUN-SYNC</p>
            </div>
            <div>
              <p className="text-gray-400">SAR SENSOR</p>
              <p className="font-bold text-[#00B4D8]">C-BAND VV+VH</p>
            </div>
            <div>
              <p className="text-gray-400">LAT / LON</p>
              <p className="font-bold text-white">15.421°N, 65.239°E</p>
            </div>
          </div>
        </div>

        {/* Card 2: Spill Detection Telemetry with 8.4 km² */}
        <div className="bg-black/60 border border-[#00F0FF]/50 backdrop-blur-xl rounded-2xl p-4 shadow-[0_0_30px_rgba(0,240,255,0.2)] transition-all hover:border-[#00F0FF]">
          <div className="flex items-center justify-between mb-1.5">
            <div className="flex items-center gap-2">
              <AlertTriangle className="w-4 h-4 text-[#E63946] animate-bounce" />
              <span className="text-[11px] font-mono font-bold tracking-wider text-[#E63946]">SPILL ANOMALY #8941</span>
            </div>
            <span className="text-[9px] font-mono font-bold px-2 py-0.5 bg-[#E63946]/20 text-[#E63946] border border-[#E63946]/40 rounded-md">UNMATCHED</span>
          </div>
          
          <div className="mt-2 mb-2">
            <p className="text-[10px] font-mono text-gray-300 font-bold">DETECTED ANOMALY SURFACE AREA</p>
            <p className="text-3xl font-extrabold font-display text-[#00F0FF] drop-shadow-[0_0_15px_rgba(0,240,255,0.8)] tracking-tight">
              8.4 <span className="text-lg font-bold text-[#00F0FF]">km²</span>
            </p>
          </div>

          <div className="space-y-1.5 text-[10px] font-mono text-gray-300 bg-black/40 p-2.5 rounded-xl border border-white/5">
            <div className="flex justify-between">
              <span className="text-gray-400">SPILL TYPE:</span>
              <span className="font-semibold text-white">Heavy Crude Oil</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-400">DRIFT VELOCITY:</span>
              <span className="font-semibold text-white">1.8 knots @ 214° SW</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-400">AI CONFIDENCE:</span>
              <span className="font-bold text-[#E63946]">94.2% MATCH</span>
            </div>
          </div>
        </div>

        {/* Card 3: Target Suspect Telemetry */}
        <div className="bg-black/60 border border-white/10 backdrop-blur-xl rounded-2xl p-4 shadow-[0_0_20px_rgba(0,0,0,0.4)] transition-all hover:border-[#00B4D8]/50">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <Ship className="w-4 h-4 text-[#F59E0B]" />
              <span className="text-[11px] font-mono font-bold tracking-wider text-[#F59E0B]">TARGET SUSPECT VESSEL</span>
            </div>
            <Crosshair className="w-3.5 h-3.5 text-gray-400" />
          </div>
          <div className="space-y-1 text-[10px] font-mono">
            <p className="text-sm font-bold text-white font-display tracking-wide">MT ALFA SEAWAY</p>
            <p className="text-gray-400">IMO 9481923 • FLAG: LIBERIA</p>
            <div className="mt-2 flex items-center justify-between text-gray-300 bg-black/40 p-2 rounded-lg">
              <span>DISTANCE TO SLICK:</span>
              <span className="font-bold text-white">1.2 nm</span>
            </div>
          </div>
        </div>

        {/* Card 4: Quick Launch Intelligence Board CTA */}
        <Link 
          href="/investigate" 
          className="group flex items-center justify-between bg-gradient-to-r from-[#0077B6] to-[#00B4D8] hover:from-[#023E8A] hover:to-[#0077B6] text-white p-3.5 rounded-2xl font-mono text-xs font-bold tracking-wider transition-all shadow-[0_0_20px_rgba(0,180,216,0.3)] hover:shadow-[0_0_30px_rgba(0,180,216,0.5)] border border-[#00B4D8]/50"
        >
